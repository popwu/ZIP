                    ...
                    <div className="p-2 space-y-2">
                      ...
                      <div className="flex justify-between gap-2">
                        <button
                          ...
                          className="flex-1 text-white bg-blue-500 hover:bg-blue-600 px-2 py-1 rounded text-sm flex items-center justify-center"
                        >
                        ...
                        <button
                          ...
                          className="text-white bg-red-500 hover:bg-red-600 px-2 py-1 rounded text-sm flex items-center justify-center"
                        >
